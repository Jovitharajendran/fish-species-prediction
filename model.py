...
train_generator = train_datagen.flow_from_directory('Dataset',target_size=(200, 200), batch_size=batch_size,
                                                    classes = [ 'Asian-Green-Bee-Eater', 'Brown-Headed-Barbet', 'Cattle-Egret',
            'Common-Kingfisher', 'Common-Myna', 'Common-Rosefinch',
            'Common-Tailorfish', 'Coppersmith-Barbet', 'Forest-Wagtail',
...
test_generator = test_datagen.flow_from_directory('Dataset', target_size=(200, 200), batch_size=batch_size,
                                                  classes = [ 'Asian-Green-Bee-Eater', 'Brown-Headed-Barbet', 'Cattle-Egret',
            'Common-Kingfisher', 'Common-Myna', 'Common-Rosefinch',
            'Common-Tailorfish', 'Coppersmith-Barbet', 'Forest-Wagtail',
            'Gray-Wagtail', 'Hoopoe', 'House-Crow', 'Indian-Grey-Hornbill',
